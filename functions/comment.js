// Cloudflare Pages Function — handles comment submissions
// Token lives in env (set in Cloudflare dashboard), never in HTML
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const put = await fetch(API, {
      ...
      body: JSON.stringify({ message: `Comment from ${name.trim()}`, content, sha }),
    });
